...
# number of bandit problems
n_bandit=2000 
# number of arms in each bandit problem
k=10 
# number of times to pull each arm
n_pulls=1000 

# generating the true means q*(a) for each arm for all bandits
q_true=np.random.normal(0,1,(n_bandit,k))
# the true optimal arms in each bandit 
